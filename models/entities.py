...
class ScreeningResult(Base):
    ...
    qualifications_score: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    matched_qualifications: Mapped[list[str]] = mapped_column(JSON, default=list)
    ...
    ai_suggestions: Mapped[list[str] | None] = mapped_column(JSON, nullable=True)
